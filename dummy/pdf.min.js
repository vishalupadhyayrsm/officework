    ...
    var __webpack_modules__ = [
        ...
        (e, t, s) => {
          ...
          t.addLinkAttributes = function addLinkAttributes(
            e,
            { url: t, target: s, rel: n, enabled: a = !0 } = {}
          ) {
            (0, r.assert)(
              t && "string" == typeof t,
          ...
          t.getXfaPageViewport = function getXfaPageViewport(
            ...
            return new PageViewport({ viewBox: a, scale: t, rotation: s });
          };
        ...
        (__unused_webpack_module, exports, __w_pdfjs_require__) => {
          ...
          function getDocument(e) {
            ...
            r.StandardFontDataFactory =
              r.StandardFontDataFactory || DefaultStandardFontDataFactory;
          ...
          class PDFPageProxy {
            ...
            render({
              ...
              if (!h.displayReadyCapability) {
                h.displayReadyCapability = (0, _util.createPromiseCapability)();
                h.operatorList = { fnArray: [], argsArray: [], lastChunk: !1 };
              ...
              const g = p.task;
              Promise.all([h.displayReadyCapability.promise, l])
                .then(([e, t]) => {
            ...
            getOperatorList({
              ...
              let r,
                n = this._intentStates.get(s.cacheKey);
              if (!n) {
              ...
              if (!n.opListReadCapability) {
                ...
                n.opListReadCapability = (0, _util.createPromiseCapability)();
                (n.renderTasks ||= new Set()).add(r);
                n.operatorList = { fnArray: [], argsArray: [], lastChunk: !1 };
                this._stats && this._stats.time("Page Request");
          ...
          class WorkerTransport {
            ...
            getRenderingIntent(e, t = _util.AnnotationMode.ENABLE, s = !1) {
              ...
              return { renderingIntent: r, cacheKey: `${r}_${n}` };
            }
            destroy() {
        ...
        (e, t, s) => {
          ...
          class LRUCache {
            ...
            set(e, t) {
              if (!(this._maxSize <= 0)) {
                this._cache.size + 1 > this._maxSize &&
          ...
          class CanvasGraphics {
            ...
            _createMaskCanvas(e) {
              ...
              m.imageSmoothingEnabled = getImageSmoothingEnabled(
                m.mozCurrentTransform,
                e.interpolate
              );
              m.drawImage(b.img, 0, 0, b.img.width, b.img.height, 0, 0, s, n);
              m.globalCompositeOperation = "source-in";
              const y = r.Util.transform(m.mozCurrentTransformInverse, [
                1,
                0,
                0,
                1,
            ...
            _getPattern(e, t = null) {
              let s;
              if (this.cachedPatterns.has(e)) s = this.cachedPatterns.get(e);
              else {
                s = (0, n.getShadingPattern)(
                  this.objs.get(e),
            ...
            paintImageMaskXObjectGroup(e) {
              ...
              for (let n = 0, a = e.length; n < a; n++) {
                ...
                c.fillStyle = r
                  ? s.getPattern(c, this, t.mozCurrentTransformInverse, !1)
                  : s;
                c.fillRect(0, 0, i, o);
                c.restore();
                t.save();
          ...
          for (const e in r.OPS)
            void 0 !== CanvasGraphics.prototype[e] &&
              (CanvasGraphics.prototype[r.OPS[e]] =
          ...
          class TilingPattern {
            ...
            getPattern(e, t, s, n = !1) {
              ...
              try {
                ...
                (0, r.warn)(`TilingPattern.getPattern: "${e?.message}".`);
              }
              return l;
            }
          }
        ...
        (e, t) => {
          ...
          class XfaText {
            static textContent(e) {
              const t = [],
                s = { items: t, styles: Object.create(null) };
              !(function walk(e) {
                if (!e) return;
                let s = null;
                const r = e.name;
                if ("#text" === r) s = e.value;
                  ...
                  if (!XfaText.shouldBuildText(r)) return;
                  e?.attributes?.textContent
                    ? (s = e.attributes.textContent)
                    : e.value && (s = e.value);
                }
                null !== s && t.push({ str: s });
        ...
        (e, t, s) => {
          ...
          class AnnotationElement {
            ...
            _getElementsByName(e, t = null) {
              ...
              for (const r of document.getElementsByName(e)) {
                ...
                e !== t &&
                  l.has(r) &&
                  s.push({ id: e, exportValue: n, domElement: r });
              }
              return s;
            }
            static get platform() {
          ...
          class LinkAnnotationElement extends AnnotationElement {
            ...
            render() {
              ...
              if (e.url) {
              ...
              } else if (e.action) this._bindNamedAction(s, e.action);
              else if (e.dest) this._bindLink(s, e.dest);
              else {
                let t = !1;
                if (
                  e.actions &&
                ...
                e.resetForm
                  ? this._bindResetFormAction(s, e.resetForm)
                  : t || this._bindLink(s, "");
              }
              if (this.quadrilaterals)
                ...
                e.onclick = () => {
                  ...
                  if (0 !== e.length || 0 !== r.length) {
                    ...
                    for (const s of e) {
                      ...
                      for (const { id: s } of e) t.add(s);
                    }
                    for (const e of Object.values(this._fieldObjects))
                      for (const s of e) t.has(s.id) === n && a.push(s);
                  } else
                    for (const e of Object.values(this._fieldObjects))
                      a.push(...e);
                  ...
                  for (const e of a) {
                    ...
                    switch (e.type) {
                      case "text": {
                        ...
                        i.setValue(t, { value: s, valueAsString: s });
                        break;
                      }
                      case "checkbox":
                      case "radiobutton": {
                        const s = e.defaultValue === e.exportValues;
                        i.setValue(t, { value: s });
                        break;
                      }
                      case "combobox":
                      case "listbox": {
            ...
            render() {
              ...
              n.addEventListener("change", (r) => {
                ...
                for (const r of this._getElementsByName(n, s)) {
                  ...
                  e.setValue(r.id, { value: s });
                }
                e.setValue(s, { value: a });
              });
                ...
                n.addEventListener("updatefromsandbox", (s) => {
                  const r = {
                    value(s) {
                      ...
                      for (const e of n.options) e.selected = a.has(e.value);
          ...
          class PopupAnnotationElement extends AnnotationElement {
            constructor(e) {
              super(e, {
                isRenderable: !(
                  !e.data.titleObj?.str && !e.data.contentsObj?.str
                ),
              });
            }
            render() {
          ...
          t.AnnotationLayer = class AnnotationLayer {
            static render(e) {
              ...
              for (const n of e.annotations)
                n &&
                  (n.annotationType !== r.AnnotationType.POPUP
                    ? t.push(n)
                    : s.push(n));
              s.length && t.push(...s);
              for (const s of t) {
        ...
        (e, t, s) => {
          ...
          class TextLayerRenderTask {
            ...
            cancel() {
              ...
              if (this._reader) {
                this._reader
                  .cancel(new r.AbortException("TextLayer task cancelled."))
                  .catch(() => {});
                this._reader = null;
              }
          ...
          t.SVGGraphics = i;
          {
            ...
            t.SVGGraphics = i = class {
              ...
              showText(t) {
                ...
                if (
                  _ === r.TextRenderingMode.FILL ||
                  _ === r.TextRenderingMode.FILL_STROKE
                ) {
          ...
          t.XfaLayer = class XfaLayer {
            ...
            static setAttributes({
              ...
              for (const [t, s] of Object.entries(i))
                if (null != s && "dataId" !== t)
                  if ("style" !== t)
                    if ("textContent" === t) e.textContent = s;
                    else if ("class" === t) e.setAttribute(t, s.join(" "));
                    else {
                      if (o && ("href" === t || "newWindow" === t)) continue;
                      e.setAttribute(t, s);
                    }
                  else Object.assign(e.style, s);
              if (o) {
                a.addLinkAttributes ||
                  (0, r.warn)(
          ...
          class NetworkManager {
            ...
            onStateChange(e, t) {
              ...
              if (206 === a) {
                ...
                i ? s.onDone({ begin: 0, chunk: i }) : s.onError?.(n.status);
            }
            getRequestXhr(e) {
