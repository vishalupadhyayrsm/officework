...
if (isset($_SESSION['user_email'])) {
    ...
    try {
        ...
        $gatepass = $stmt->fetchAll(PDO::FETCH_ASSOC);
         ...
         /* code for dispalying the certificate list start here  */ 
    ...
    <script>
          if (typeof Tabulator !== 'undefined') {
            ...
            function updateaddedcartInfo(pid, userId, newValue, username) {
               ...
               var currentDateTime = new Date().toLocaleString('en-IN', { timeZone: 'Asia/Kolkata' });
